...
namespace TesBlazor1.Models.Entities
{
    public class UserAccount
    {
        ...
        public static List<UserAccount> GetDummyUsers()
        {
            ...
            {
                new UserAccount { Username = "dika", Password = "password1", Name = "Ramadhan Surya", Nopek = "2070", Role = "HC", PRL = "18", Section = "HC", Position = "Manager Area HC", Points = 1500},
                new UserAccount { Username = "dinda", Password = "password2", Name = "Dinda Rachma", Nopek = "2056", Role = "HC", PRL = "22", Section = "HC", Position = "Section Head HC", Points = 1324},
